...
public class WorldDifficultyHardItem extends GuiItem {
    private final ManhuntConfiguration game;

    public WorldDifficultyHardItem(GuiInventory inventory) {
        super(inventory);
    ...
    public List<String> getLore() {
        return List.of(
                ChatColor.GOLD + "Presents a hard world to",
                ChatColor.GOLD + "play Manhunt in.",
                ChatColor.RED + "WARNING: It is difficult for speedrunners",
                ChatColor.RED + "to win in hard worlds.",
                ChatColor.RED + "Consider handicaps or buffs for them in this mode."
        );
    }
    ...
    public void click(Player player) {
        ...
        game.getWorldSettings().setDifficulty(Difficulty.HARD);
